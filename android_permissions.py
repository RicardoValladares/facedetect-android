...
class AndroidPermissions:
    ...
    def no_permission_view(self):
        view = ModalView()
        view.add_widget(Button(text='Permiso NO concedido.\n\n' +'Toca para salir de la aplicacion.\n\n\n' +'Si seleccionó "No permitir",\n' +'habilite el permiso en las configuraciones.',on_press=self.bye))
        view.open()
